...
#define sensorNum 8
#define maxSpeed 250
#define rotationSpeed 200

int blackLimit[sensorNum];

const int motorPin1 = 8,motorPin2 = 9;        //right motor
const int motorPin3 = 12,motorPin4 = 11;       //left motor
...
int pidAllWhite=0,turnAllWhite=0,allWhite=0,fSpeed=150 , brakeDelay=125;
